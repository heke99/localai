...
console.log("[agent-kernel-gpuhub-evidence-workflow] loaded verifier uses non-stream generate semantics; four-second gate and production sampling state unchanged");
