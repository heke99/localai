...
const tools: GatewayTool[] = [
  ...
  { name: "github_read_branch_ref", provider: "github", capability: "github.contents.read" },
  { name: "github_restore_agent_branch", provider: "github", capability: "github.contents.write" },
