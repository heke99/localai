...
select ok(has_function_privilege('service_role', 'public.service_delete_runtime_canary_tool_execution(text)', 'EXECUTE'), 'service_role can clean canary tool execution');
