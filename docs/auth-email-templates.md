...
- exactly six digits
- generated by Supabase Auth using its secure OTP generation path
- accepted for at most 5 minutes by the application
- bound to the current Supabase `session_id`
- at most 5 failed attempts before a 15-minute lock
