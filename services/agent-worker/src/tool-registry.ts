...
const policies: ToolPolicy[] = [
  ...
  { name: "http_request", allowedModes: LAB_READ, capability: "security.active", risk: "active", mutating: true, destructive: false, reversible: false, idempotent: false, cancellable: true, timeoutMs: 45_000, scopePolicy: "resource", evidenceType: "security", directExposure: true },
